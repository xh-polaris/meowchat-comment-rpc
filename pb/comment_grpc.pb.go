...
const (
	CommentRpc_CreateComment_FullMethodName                = "/comment.comment_rpc/createComment"
	CommentRpc_UpdateComment_FullMethodName                = "/comment.comment_rpc/updateComment"
	CommentRpc_DeleteComment_FullMethodName                = "/comment.comment_rpc/deleteComment"
	CommentRpc_ListCommentByParent_FullMethodName          = "/comment.comment_rpc/listCommentByParent"
	CommentRpc_CountCommentByParent_FullMethodName         = "/comment.comment_rpc/countCommentByParent"
	CommentRpc_RetrieveCommentById_FullMethodName          = "/comment.comment_rpc/retrieveCommentById"
	CommentRpc_ListCommentByAuthorIdAndType_FullMethodName = "/comment.comment_rpc/listCommentByAuthorIdAndType"
	CommentRpc_ListCommentByReplyToAndType_FullMethodName  = "/comment.comment_rpc/listCommentByReplyToAndType"
)
...
func (c *commentRpcClient) ListCommentByParent(ctx context.Context, in *ListCommentByParentRequest, opts ...grpc.CallOption) (*ListCommentByParentResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommentRpc_ListCommentByParent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentRpcClient) CountCommentByParent(ctx context.Context, in *CountCommentByParentRequest, opts ...grpc.CallOption) (*CountCommentByParentResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommentRpc_CountCommentByParent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentRpcClient) RetrieveCommentById(ctx context.Context, in *RetrieveCommentByIdRequest, opts ...grpc.CallOption) (*RetrieveCommentByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommentRpc_RetrieveCommentById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentRpcClient) ListCommentByAuthorIdAndType(ctx context.Context, in *ListCommentByAuthorIdAndTypeRequest, opts ...grpc.CallOption) (*ListCommentByAuthorIdAndTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommentRpc_ListCommentByAuthorIdAndType_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentRpcClient) ListCommentByReplyToAndType(ctx context.Context, in *ListCommentByReplyToAndTypeRequest, opts ...grpc.CallOption) (*ListCommentByReplyToAndTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CommentRpc_ListCommentByReplyToAndType_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CommentRpc_ListCommentByParent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentRpc_ListCommentByParent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CommentRpc_CountCommentByParent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentRpc_CountCommentByParent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CommentRpc_RetrieveCommentById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentRpc_RetrieveCommentById_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CommentRpc_ListCommentByAuthorIdAndType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentRpc_ListCommentByAuthorIdAndType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CommentRpc_ListCommentByReplyToAndType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentRpc_ListCommentByReplyToAndType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
